...
write.csv(dfx, "ignore/08_proportional_varImp_varexpl_CV.csv")

dfx <- read.csv("ignore/08_proportional_varImp_varexpl_CV.csv")

## upload original variable importance
origVarImp <- read.csv("output_data/06_CV_var_imp.csv") %>%
...
file.name1 <- "Figures/08_relative_importance_CV_sens_analysis.jpg"
...
file.name1 <- "Figures/08_relative_importance_CV_comparison_plot.jpg"
